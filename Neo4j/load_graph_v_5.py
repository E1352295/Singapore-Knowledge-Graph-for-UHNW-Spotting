...
def main():
    ...
    ap.add_argument("--neo4j_export", default="<Base Folder>/SGX Annual Reports/Case Study/Venture Corporation Limited/neo4j_query_table_data_2025-6-26.json", help="Cypher JSON export from SGX annual‑report query")
    ap.add_argument("--wikidata_json", default="C:/Users/22601/Downloads/downloads/wikiData/data.json", help="Simplified Wikidata JSON")
    ap.add_argument("--mas_csv", default="<Base Folder>/MAS/MAS_Personnel_merged.csv", help="MAS personnel merged CSV")
